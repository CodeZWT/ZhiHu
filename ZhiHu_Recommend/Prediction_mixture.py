...
SocialFile = u"Data/Followees/Train.txt"
TestFile = u"Data/Followees/Test.txt"
UserItemFile = u"Data/Topic.txt"



Social_Data = np.loadtxt(SocialFile)
Test_Data = np.loadtxt(TestFile)
UserItem_Data = np.loadtxt(UserItemFile,delimiter=',')
...
print MatrixDegree_User
print MatrixDegree_User.shape
print np.linalg.det(MatrixDegree_User)
